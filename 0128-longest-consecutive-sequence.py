...
# If not, that element n starts a sequence. Now since the sequence has started, check if we have n+1, n+2, n+3, etc. and keep incrementing count.
...
# TC =  O(n) (linear time solution- we are iterating through array and expanding each range- so we will be visting an element at most twice)  
